<script lang="ts" context="module">
  ...
  <div
    ...
    <div class="avatar mb-10">
      <div class="rounded-full border-2 border-white shadow-xl w-36 h-45">
        <img
          class="hover:rotate-[360deg] !object-fill transition-transform duration-1000 ease-in-out m-0"
